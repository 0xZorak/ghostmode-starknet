...
```bash
npm install
cp .env.example .env.local     # add your Alchemy key as NEXT_PUBLIC_ALCHEMY_KEY
...
Standard Next.js on [Vercel](https://vercel.com/new) — set `NEXT_PUBLIC_ALCHEMY_KEY` (and optionally `NEXT_PUBLIC_STRK20_ECHO_HELPER_SEPOLIA`).
